package me.dmillerw.inspection.client.gui.widget;
...
public class GuiButtonArrow extends GuiButtonExt {
    ...
    private static final ResourceLocation BUTTON_ARROWS = new ResourceLocation(ModInfo.MOD_ID, "textures/gui/arrows.png");
